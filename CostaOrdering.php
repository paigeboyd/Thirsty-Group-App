            ...
            <section id="services-section" class="page text-center">
				...
				<fieldset id="contactdetails" class="text-center wow zoomIn">
                   ...
                   <br />
                    ...
                    <br />
					<label for="EmailAdd">Email Address: </label> <input type="email" name="EmailAddress" id="EmailAddress" class="stored" placeholder="Email Address" required> *<br />
                ...
                <br />
				 ...
				 <fieldset id="Details" class="text-center wow zoomIn">
                  ...
                  <br />
                     ...
                     <iframe width='70%' height='300px' frameBorder='0' src='https://a.tiles.mapbox.com/v4/linzi-mccord.pcd5n20e/attribution,zoompan,zoomwheel,geocoder,share.html?access_token=pk.eyJ1IjoibGluemktbWNjb3JkIiwiYSI6ImNpajJrdnJ0ZzAwMDV3N20yM21kbGhzZG4ifQ.aeIqEnGE1khM-hb2frxczw'></iframe>
                     <br />
                     <br />
...
<label for="location" class="labelpadding">Location:</label> 
					        <select id="CafeLocation" name="CafeLocation" class="stored">
                                <optgroup label="Belfast">
                                    ...
                                    <option value="Balmoral Plaza">Balmoral Centre</option>
                                    <option value="Hollywood Exchange">Hollywood Exchange </option>
                                    <option value="Abbey Centre">Abbey Centre</option>
				...
				<fieldset type="text" id="additionalcomments" class="stored" class="text-center wow zoomIn">
