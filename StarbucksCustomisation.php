       ...
       <form id="myform" method="post" action="Ordering.php" name="myemailform" id="myform">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <span href="#" class="rotate-box-2 square-icon text-center wow zoomIn" data-wow-delay="0.2s">
                                    ...
                                    <div class="rotate-box-info">
                                        <input type="radio" name="size" value="Tall" id="size" name="size">
                                        <label for="img2">Tall </label>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-2 square-icon text-center wow zoomIn" data-wow-delay="0.6s">
                                   <img class="venti" src="img/customisation/cup4.png" >
                                    <div class="rotate-box-info">
                                         <input type="radio" name="size" value="Venti" id="size">
                                            <label for="img4">Venti </label> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <span href="#" class="rotate-box-2 square-icon text-center wow zoomIn" data-wow-delay="0.4s">
                                    ...
                                    <div class="rotate-box-info">
                                         <input type="radio" value="Coconut Milk" name="milk" id="milk">
                                        <label class="milk">Coconut </label>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-2 square-icon text-center wow zoomIn" data-wow-delay="0.6s">
                                   <img class="venti" src="img/customisation/nomilk.png">
                                    <div class="rotate-box-info">
        ...
        <select id="syrup" name="syrup">
                                <optgroup label="Belfast">
                                    ...
                                    <option value="Chocolate Syrup" name="syrup" id="button2">Chocolate Syrup</option>
                                    ...
                                    <option value="Peppermint Syrup" name="syrup" id="button4">Peppermint Syrup</option>
                                    <option value="Pumpkin Spice Syrup" name="syrup" id="button5">Pumpkin Spice Syrup</option>
                                    <option value="Toffee Nut Syrup" name="syrup" id="button5">Toffee Nut Syrup</option>
                                    <option value="Vanilla Syrup" name="syrup" id="button7">Vanilla Syrup</option>
                                    <option value="White Chocolate Syrup" name="syrup" id="button8">White Chocolate Syrup</option>
